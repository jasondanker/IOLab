...
def submitSurvey():
	...
	if 'username' in session:
		...
		surveyResponse['t-io-lab'] = request.form.get('ioLab')
		surveyResponse['t-other-work'] = request.form.get('otherWork')
		surveyResponse['t-commute'] = request.form.get('commute')
		surveyResponse['t-relax'] = request.form.get('relax')
